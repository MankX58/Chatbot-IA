      ...
      <div className="w-full max-w-xl rounded-2xl border border-neutral-100 bg-white px-4 py-6 shadow sm:px-6 md:px-10">
        ...
        <div className="mb-6">
          ...
          <p className="mb-3 text-xs leading-relaxed text-neutral-500">
            ...
            <a
              className="font-medium text-[#B71C1C] hover:underline"
        ...
        <div className="flex gap-2 rounded-[10px] border border-neutral-100 bg-neutral-50 px-4 py-3">
          ...
          <p className="m-0 text-xs leading-relaxed text-neutral-500">
            Tu API key solo se conserva durante la sesion activa del navegador. No se persiste en almacenamiento permanente.
          </p>
        </div>
      </div>
    </main>
