    ...
    <header className="sticky top-0 z-50 flex items-center justify-between gap-3 border-b-[3px] border-b-[#B71C1C] bg-white px-4 py-3 shadow-sm md:px-8">
      <div className="flex min-w-0 items-center gap-2 sm:gap-3">
        <button
          ...
          aria-label={showNavMenu ? 'Cerrar menu' : 'Abrir menu'}
        ...
        >
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 className="max-w-48 truncate text-left text-[0.95rem] font-bold tracking-[-0.02em] text-[#1a1a2e] sm:max-w-none md:text-[1.1rem]">
                Soporte Tecnologico UdeM
              </h1>
              <p className="hidden text-xs text-neutral-400 md:block">Chat, soporte y monitoreo operativo</p>
            </div>
          </div>
        </button>
      </div>
      ...
      >
        ...
        <div className={`relative mx-3 overflow-hidden rounded-b-3xl border border-t-0 border-neutral-200 bg-white shadow-2xl transition-all duration-200 ${showNavMenu ? 'translate-y-0 opacity-100' : '-translate-y-3 opacity-0'}`}>
          <div className="flex items-center justify-between border-b border-neutral-100 px-4 py-4">
            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-neutral-400">Navegacion</p>
            <span className="rounded-full bg-[#fce4ec] px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#B71C1C]">Menu</span>
          </div>
